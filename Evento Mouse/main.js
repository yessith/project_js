...
lienzo.addEventListener("mousedown", iniciarLinea);
function iniciarLinea(mouse_down) {
  iniciar_dibujo = true;
  x_ini = mouse_down.offsetX;
  y_ini = mouse_down.offsetY;
}

lienzo.addEventListener("mousemove", moverLinea);
function moverLinea(mouse_move) {
  if (iniciar_dibujo === true) {
    var x_fin = mouse_move.offsetX;
    var y_fin = mouse_move.offsetY;
...
lienzo.addEventListener("mouseup", finLinea);
function finLinea(mouse_up) {
